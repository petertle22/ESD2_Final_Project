-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_fifo_data_OUT
-- Source Path: subtracti_ip/subtracti_ip_axi4_stream_video_master/subtracti_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_fifo_data_OUT IS
...
END subtracti_ip_fifo_data_OUT;


ARCHITECTURE rtl OF subtracti_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT subtracti_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : subtracti_ip_SimpleDualPortRAM_generic
    USE ENTITY work.subtracti_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_subtracti_ip_fifo_data_OUT_classic_ram_generic : subtracti_ip_SimpleDualPortRAM_generic
