-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_adapter_in
-- Source Path: subtracti_ip/subtracti_ip_axi4_stream_video_slave/subtracti_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_adapter_in IS
...
END subtracti_ip_adapter_in;


ARCHITECTURE rtl OF subtracti_ip_adapter_in IS

  -- Component Declarations
  COMPONENT subtracti_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : subtracti_ip_adapter_in_module
    USE ENTITY work.subtracti_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(63 DOWNTO 0);  -- ufix64

BEGIN
  u_subtracti_ip_subtracti_ip_axi4_stream_video_slave_subtracti_ip_adapter_in_subtracti_ip_adapter_in_module : subtracti_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
