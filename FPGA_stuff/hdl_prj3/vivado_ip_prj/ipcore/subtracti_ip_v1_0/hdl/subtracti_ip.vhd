-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip.vhd
...
ARCHITECTURE rtl OF subtracti_ip IS

  -- Component Declarations
  COMPONENT subtracti_ip_reset_sync
  ...
  COMPONENT subtracti_ip_axi_lite
  ...
  COMPONENT subtracti_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Slave_TDATA   :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  COMPONENT subtracti_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : subtracti_ip_reset_sync
    USE ENTITY work.subtracti_ip_reset_sync(rtl);

  FOR ALL : subtracti_ip_axi_lite
    USE ENTITY work.subtracti_ip_axi_lite(rtl);

  FOR ALL : subtracti_ip_axi4_stream_video_slave
    USE ENTITY work.subtracti_ip_axi4_stream_video_slave(rtl);

  FOR ALL : subtracti_ip_dut
    USE ENTITY work.subtracti_ip_dut(rtl);

  FOR ALL : subtracti_ip_axi4_stream_video_master
    USE ENTITY work.subtracti_ip_axi4_stream_video_master(rtl);
...
BEGIN
  u_subtracti_ip_reset_sync_inst : subtracti_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_subtracti_ip_axi_lite_inst : subtracti_ip_axi_lite
  ...
  u_subtracti_ip_axi4_stream_video_slave_inst : subtracti_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_subtracti_ip_dut_inst : subtracti_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_subtracti_ip_axi4_stream_video_master_inst : subtracti_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"8F4E4402");
