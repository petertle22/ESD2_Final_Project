-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip_fifo_eol.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_fifo_eol
-- Source Path: subtracti_ip/subtracti_ip_axi4_stream_video_slave/subtracti_ip_fifo_eol
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_fifo_eol IS
...
END subtracti_ip_fifo_eol;


ARCHITECTURE rtl OF subtracti_ip_fifo_eol IS
...
BEGIN
  ...
  u_subtracti_ip_fifo_eol_classic_ram : subtracti_ip_SimpleDualPortRAM_singlebit
