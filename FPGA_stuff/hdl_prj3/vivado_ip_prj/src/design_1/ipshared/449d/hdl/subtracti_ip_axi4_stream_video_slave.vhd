-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip_axi4_stream_video_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_axi4_stream_video_slave
-- Source Path: subtracti_ip/subtracti_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_axi4_stream_video_slave IS
...
END subtracti_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF subtracti_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT subtracti_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT subtracti_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT subtracti_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT subtracti_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : subtracti_ip_fifo_eol
    USE ENTITY work.subtracti_ip_fifo_eol(rtl);

  FOR ALL : subtracti_ip_fifo_sof
    USE ENTITY work.subtracti_ip_fifo_sof(rtl);

  FOR ALL : subtracti_ip_adapter_in
    USE ENTITY work.subtracti_ip_adapter_in(rtl);

  FOR ALL : subtracti_ip_fifo_data
    USE ENTITY work.subtracti_ip_fifo_data(rtl);
...
BEGIN
  u_subtracti_ip_fifo_eol_inst : subtracti_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_subtracti_ip_fifo_sof_inst : subtracti_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_subtracti_ip_subtracti_ip_axi4_stream_video_slave_subtracti_ip_adapter_in : subtracti_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_subtracti_ip_fifo_data_inst : subtracti_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
