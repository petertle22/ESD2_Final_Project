-- -------------------------------------------------------------
-- 
-- File Name: S:\Documents\ESD2_Final_Project\FPGA_stuff\hdl_prj3\hdlsrc\ImageProcessingNoShift\subtracti_ip_fifo_eol_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_fifo_eol_out
-- Source Path: subtracti_ip/subtracti_ip_axi4_stream_video_master/subtracti_ip_fifo_eol_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_fifo_eol_out IS
...
END subtracti_ip_fifo_eol_out;


ARCHITECTURE rtl OF subtracti_ip_fifo_eol_out IS
...
BEGIN
  ...
  u_subtracti_ip_fifo_eol_out_classic_ram : subtracti_ip_SimpleDualPortRAM_singlebit
