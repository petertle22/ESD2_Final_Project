...
proc create_root_design { parentCell } {
  ...
  # Create instance: subtracti_ip_0, and set properties
  set subtracti_ip_0 [ create_bd_cell -type ip -vlnv rit.edu:ip:subtracti_ip:1.0 subtracti_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins subtracti_ip_0/AXI4_Stream_Video_Slave]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins subtracti_ip_0/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net subtracti_ip_0_AXI4_Stream_Video_Master [get_bd_intf_pins axi_vdma_2/S_AXIS_S2MM] [get_bd_intf_pins subtracti_ip_0/AXI4_Stream_Video_Master]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs subtracti_ip_0/AXI4_Lite/reg0] SEG_subtracti_ip_0_reg0
