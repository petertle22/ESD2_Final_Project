...
imageStack(:,:,1) = leftDataGray;
imageStack(:,:,2) = leftEmptyGray;
imageStack(:,:,3) = leftDataGray;
imageStack(:,:,4) = leftEmptyGray;
imageStack(:,:,5) = rightDataGray;
imageStack(:,:,6) = rightEmptyGray;
imageStack(:,:,7) = rightDataGray;
imageStack(:,:,8) = rightEmptyGray;
