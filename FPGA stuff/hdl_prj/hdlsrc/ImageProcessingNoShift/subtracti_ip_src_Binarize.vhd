-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ImageProcessingNoShift\subtracti_ip_src_Binarize.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: subtracti_ip_src_Binarize
-- Source Path: ImageProcessingNoShift/subtraction_core/Subsystem1/Binarize
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY subtracti_ip_src_Binarize IS
  PORT( u                                 :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        Out1                              :   OUT   std_logic_vector(7 DOWNTO 0)  -- uint8
        );
END subtracti_ip_src_Binarize;


ARCHITECTURE rtl OF subtracti_ip_src_Binarize IS
